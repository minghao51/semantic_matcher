...
### New Files Created
- `src/semanticmatcher/core/async_utils.py` - AsyncExecutor helper class for running sync operations in thread pool
...
### Modified Files
- `src/semanticmatcher/core/matcher.py` - Add async methods to Matcher, EntityMatcher, and EmbeddingMatcher classes
...
**Files:**
- Create: `src/semanticmatcher/core/async_utils.py`
...
Expected: FAIL with "ModuleNotFoundError: No module named 'semanticmatcher.core.async_utils'"
...
```bash
git add src/semanticmatcher/core/async_utils.py tests/test_core/test_async_utils.py
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py:122-198` (Matcher.__init__ section)
...
Add to `Matcher.__init__` in `src/semanticmatcher/core/matcher.py` (around line 176, after `self._verbose = verbose`):
...
```bash
git add src/semanticmatcher/core/matcher.py tests/test_core/test_async_matcher.py
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py:448-449` (replace stub fit_async)
- Test: `tests/test_core/test_async_matcher.py`
...
Replace the stub `fit_async` in `src/semanticmatcher/core/matcher.py`:
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py:450-508` (add after match method)
- Test: `tests/test_core/test_async_matcher.py`
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py` (add after match_async)
- Test: `tests/test_core/test_async_matcher.py`
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py` (add after match_batch_async)
- Test: `tests/test_core/test_async_matcher.py`
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py:781-914` (EntityMatcher class)
- Test: `tests/test_core/test_async_matcher.py`
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py:916-1126` (EmbeddingMatcher class)
- Test: `tests/test_core/test_async_matcher.py`
...
**Files:**
- Modify: `src/semanticmatcher/core/matcher.py` (update match_batch_async)
- Test: `tests/test_core/test_async_matcher.py`
...
Run: `uv run pyright src/semanticmatcher/core/async_utils.py src/semanticmatcher/core/matcher.py`
Expected: No type errors (or acceptable warnings)

- [ ] **Step 2: Run linter**

Run: `uv run ruff check src/semanticmatcher/core/async_utils.py src/semanticmatcher/core/matcher.py`
Expected: No linting errors

- [ ] **Step 3: Format code**

Run: `uv run ruff format src/semanticmatcher/core/async_utils.py src/semanticmatcher/core/matcher.py`
Expected: Code formatted

- [ ] **Step 4: Commit**

```bash
git add src/semanticmatcher/core/async_utils.py src/semanticmatcher/core/matcher.py
